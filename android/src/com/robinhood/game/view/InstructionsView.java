...
public class InstructionsView extends View {
    ...
    public InstructionsView(Controller controller) {
        ...
        headerText.setFontScale(1.5f);
        instructions1.setFontScale(1.5f);
        instructions2.setFontScale(1.5f);
        instructions3.setFontScale(1.5f);

        table.bottom();
        table.row().pad(0f, 0, 0f, 0);
